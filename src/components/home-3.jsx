                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 py-3">
                    <div className="cardOffer cursor rounded-3 position-relative z-0">
                      <div className="cardOffer-image ratio ratio-full">
                        <img className="img-fluid object-fit" src="https://placehold.co/1500x1000" alt="image" />
                      </div>
                      <div className="cardOffer-content p-5">
                        ...
                        <div className="d-flex mt-5">
                          <a href="#" className="btn btn-whitener fw-medium px-5">Experiences<i className="fa-solid fa-arrow-trend-up ms-2" /></a>
                        </div>
                      </div>
                    </div>
                  </div>

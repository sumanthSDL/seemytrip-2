      ...
      return (
        <div>
          ...
          <div id="main-wrapper">
            ...
            {/* ============================================================== */}
            {/* ============================ Booking Title ================================== */}
            <section className="bg-cover position-relative" style={{background: 'url(https://placehold.co/2200x1200)no-repeat'}} data-overlay={5}>
              <div className="container">
                <div className="row align-items-center justify-content-center">
                  <div className="col-xl-7 col-lg-9 col-md-12">
                    <div className="fpc-capstion text-center my-4">
                      <div className="fpc-captions">
                        <h1 className="xl-heading text-light">About GeoTrip &amp; Our Mission</h1>
              ...
              <div className="container">
                <div className="row align-items-center justify-content-between g-4">
                  <div className="col-xl-6 col-lg-6 col-md-6">
                    <div className>
                      <h2 className="lh-base fs-1 fw-bold">Who We're &amp; Mission?</h2>
                  ...
                  <div className="col-xl-5 col-lg-6 col-md-6">
                    <div className="position-relative">
                      <img src="https://placehold.co/1000x1000" className="img-fluid" alt="" />
                    </div>
                  </div>
                </div>
              </div>

      ...
      return (
        <div>
          ...
          <div id="main-wrapper">
              ...
              <div className="container">
                <nav id="navigation" className="navigation navigation-landscape">
                  <div className="nav-header">
                    <a className="nav-brand" href="#"><img src="assets/img/logo.png" className="logo" alt="" /></a>
                ...
                <div className="row justify-content-between align-items-center">
                  <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div className="position-relative mb-5">
                      <div className="d-inline-flex align-items-center text-md text-muted-2 fw-semibold mb-2"><span className="square--30 circle bg-light-success text-success me-2"><i className="fa-regular fa-face-laugh-beam" /></span>Hurry Up! 20% off on domestic flights</div>
                      <h1 className="xl-heading">Book Your Next Tour with <span className="position-relative z-4">GeoTrip<span className="position-absolute top-50 start-50 translate-middle d-none d-md-block mt-4">
                    ...
                    <div className="position-relative search-wrap with-label mb-lg-0 mb-4">
                      <div className="row align-items-center justify-content-between">
                        <div className="col-xl-12 col-lg-12 col-12">
                          <div className="form-group border rounded-1 mb-4">
                            <label>Where</label>
                        ...
                        <div className="col-xl-6 col-lg-6 col-12">
                          <div className="form-group mb-4">
                            ...
                            <input type="text" className="form-control choosedate fw-bold" placeholder="Check In" readOnly="readonly" />
                          </div>
                        </div>
                        <div className="col-xl-6 col-lg-6 col-12">
                          <div className="form-group mb-4">
                            <label>Choose Date</label>
                            <input type="text" className="form-control choosedate fw-bold" placeholder="Check Out" readOnly="readonly" />
                          </div>
                        </div>
                        <div className="col-xl-12 col-lg-12 col-12">
                          <div className="form-group mb-4">
                        ...
                        <div className="col-xl-12 col-lg-12 col-12">
                          <button type="button" className="btn btn-light-primary full-width rounded-2 fw-medium">Check Availability<i className="fa-solid fa-arrow-right-long me-2" /></button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    <img src="https://placehold.co/1000x1200" className="img-fluid" alt="" />
                  </div>
                </div>
                {/* </row> */}
              </div>
            ...
            {/* ============================ Our Partners =========================== */}
            {/* ============================ Explore Places For Stay =========================== */}
            <section>
              <div className="container">
                <div className="row align-items-center justify-content-center">
                  <div className="col-xl-8 col-lg-9 col-md-11 col-sm-12">
                    <div className="secHeading-wrap text-center mb-5">
                      <h2>Hot Places In The World</h2>
                    ...
                    <div className="main-carousel cols-4 dots-full">
                      ...
                      <div className="carousel-cell">
                        <div className="pop-touritem mb-4">
                          <a href="flight-search.html" className="card rounded-3 shadow-wrap h-100 m-0">
            ...
            <div className="position-relative py-5 bg-cover bg-primary" style={{background: 'url(https://placehold.co/2200x1200)no-repeat'}} data-overlay={5}>
              <div className="container">
                <div className="row align-items-center justify-content-between">
                  <div className="col-xl-12 col-lg-12 col-md-12">

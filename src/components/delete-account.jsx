                ...
                <div className="row">
                  <div className="col-xl-12 col-lg-12 col-md-12">
                    <ul className="user-Dashboard-menu">
                      ...
                      <li className="active"><a href="delete-account.html"><i className="fa-solid fa-trash-can me-2" />Delete
                          Profile</a></li>
                      <li><a href="login.html"><i className="fa-solid fa-power-off me-2" />Sign Out</a></li>
                    </ul>
                  </div>
                      ...
                      <div className="card-body">
                        <div className="eportledd mb-4">
                          ...
                          <div className="form-check ps-0">
                            Take a backup of your data <a href="#" className="text-primary">Here</a>
                          </div>
                        </div>
                        <form className="mb-3">
                        ...
                        <div className="d-sm-flex justify-content-start">
                          ...
                          <a href="#" className="btn btn-md btn-light-primary fw-medium mb-0">Delete Account</a>
                        </div>
                      </div>
                    </div>
                  </div>

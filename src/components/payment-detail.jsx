      ...
      return (
        <div>
          ...
          <div id="main-wrapper">
                ...
                <div className="row">
                  <div className="col-xl-12 col-lg-12 col-md-12">
                    <ul className="user-Dashboard-menu">
                      ...
                      <li><a href="my-booking.html"><i className="fa-solid fa-ticket me-2" />My Booking</a></li>
                      <li><a href="travelers.html"><i className="fa-solid fa-user-group me-2" />Travelers</a></li>
                      <li className="active"><a href="payment-detail.html"><i className="fa-solid fa-wallet me-2" />Payment
                          Details</a></li>
                      <li><a href="my-wishlists.html"><i className="fa-solid fa-shield-heart me-2" />My Wishlist</a></li>
                            ...
                            <div className="card h-100">
                              <div className="bg-dark p-4 rounded-3">
                                <div className="d-flex justify-content-between align-items-start">
                                  <img className="img-fluid" src="assets/img/visa.png" width={55} alt="" />
                                  {/* Card action START */}
                                  <div className="dropdown">
                                    <a className="text-white" href="#" id="creditcardDropdown" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                      {/* Dropdown Icon */}
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="creditcardDropdown">
                                      <li><a className="dropdown-item" href="#"><i className="bi bi-credit-card-2-front-fill me-2 fw-icon" />Edit card</a></li>
                                      <li><a className="dropdown-item" href="#"><i className="bi bi-calculator me-2 fw-icon" />Currency converter</a></li>
                                    </ul>
                                  </div>
                                  {/* Card action END */}
                                </div>
                          ...
                          <div className="col-xl-5 col-lg-6 col-md-6">
                            <div className="card h-100">
                              <div className="bg-seegreen p-4 rounded-3">
                                <div className="d-flex justify-content-between align-items-start">
                                  <img className="img-fluid" src="assets/img/card.png" width={55} alt="" />
                                  {/* Card action START */}
                                  <div className="dropdown">
                                    <a className="text-white" href="#" id="creditcardDropdown1" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                      {/* Dropdown Icon */}
                                      <svg width={24} height={24} fill="none">
                                        <circle fill="currentColor" cx="12.5" cy="3.5" r="2.5" />
                                        <circle fill="currentColor" opacity="0.5" cx="12.5" cy="11.5" r="2.5" />
                          ...
                          <div className="col-xl-2 col-lg-6 col-md-6">
                            <div className="card d-flex align-items-center justify-content-center border br-dashed border-2 py-3 h-100">
                              <div className="d-flex align-items-center justify-content-center">
                                <a href="#" className="square--60 circle bg-light-primary text-primary fs-2" data-bs-toggle="modal" data-bs-target="#addcard"><i className="fa-solid fa-circle-plus" /></a>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            {/* End Modal */}
            {/* Add card Modal */}
            <div className="modal fade" id="addcard" tabIndex={-1} role="dialog" aria-labelledby="addcardmodal" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered addcard-pop-form" role="document">
                <div className="modal-content" id="addcardmodal">
                  <div className="modal-header">
                    <h4 className="modal-title fs-6">Add New Card</h4>
                    <a href="#" className="text-muted fs-4" data-bs-dismiss="modal" aria-label="Close"><i className="fa-solid fa-square-xmark" /></a>
                  </div>
                  <div className="modal-body">
                    <div className="modal-addcard-form pb-4 pt-0">
                      <form className="row align-items-start g-3">
                        <div className="col-xl-12 col-lg-12 col-md-12">
                          <div className="form-group">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12">
                          <div className="row g-3">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-5 col-5">
                              <div className="form-group">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12">
                          <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Daniel Duekoza" />
                          </div>
                        </div>
                        <div className="col-xl-12 col-lg-12 col-md-12">
                          <button type="button" className="btn btn-md btn-primary full-width fw-medium">Add New Card</button>
                        </div>
                      </form>
                    </div>
                  </div>

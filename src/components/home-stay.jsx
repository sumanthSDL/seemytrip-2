      ...
      return (
        <div>
          ...
          <div id="main-wrapper">
            ...
            {/* ============================================================== */}
            {/* ============================ Hero Banner  Start================================== */}
            <div className="image-cover hero-header bg-white" style={{background: 'url(https://placehold.co/2200x1200)no-repeat'}} data-overlay={3}>
              <div className="container">
                {/* Search Form */}
                      ...
                      <a href="flight-search.html" className="card rounded-3 border m-0">
                        <div className="offers-container row align-items-center">
                          <div className="offers-flex position-relative col-4">
                            <div className="offers-pic p-2"><img src="https://placehold.co/800x800" className="img-fluid rounded" alt="" /></div>
                          </div>
                      ...
                      <a href="flight-search.html" className="card rounded-3 border m-0">
                        <div className="offers-container row align-items-center">
                          ...
                          <div className="offers-captions col-8 ps-2">
                            ...
                            <div className="booking-wrapes d-flex align-items-center justify-content-between">
                              <p className="fs-5 low-price m-0"><span className="tag-span">Valid 31 July 2023</span></p>
                            </div>
                          </div>
                        </div>
                      </a>
                        ...
                        <div className="touritem-middle position-relative p-3">
                          <div className="touritem-flexxer">
                            <div className="d-flex align-items-start justify-content-start flex-column">
                              ...
                              <h4 className="city fs-6 m-0 fw-bold">
                                <span>Excelsior Real Estate</span>
                              </h4>
                            </div>
                            <div className="detail ellipsis-container mt-3">
                              <span className="ellipsis">3 Beds</span>

            ...
            <section>
              <div className="container">
                <div className="row justify-content-between g-4 mb-5">
                  <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="card p-4 rounded-4 border br-dashed text-center h-100">
                      ...
                      <div className="crds-desc">
                        <h5>Drop a Mail</h5>
                        <p className="fs-6 text-md lh-2 mb-0">Themezhub@gmail.com<br />Paythemezhub@gmail.com</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-4 col-lg-4 col-md-6">
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="card p-4 rounded-4 border br-dashed text-center h-100">
                      <div className="crds-icons d-inline-flex mx-auto mb-3 text-primary fs-2"><i className="fa-solid fa-globe" />
                      </div>
                      <div className="crds-desc">
                        <h5>Connect with Social</h5>
                        <p className="text-md lh-2">Let's Connect with Us via social media</p>
                        <ul className="list-inline mb-0">
                          <li className="list-inline-item"> <a className="square--40 circle gray-simple color--facebook" href="#"><i className="fa-brands fa-facebook-f" /></a> </li>
                          <li className="list-inline-item"> <a className="square--40 circle gray-simple color--instagram" href="#"><i className="fa-brands fa-instagram" /></a> </li>
                          <li className="list-inline-item"> <a className="square--40 circle gray-simple color--twitter" href="#"><i className="fa-brands fa-twitter" /></a> </li>
                          <li className="list-inline-item"> <a className="square--40 circle gray-simple color--dribbble" href="#"><i className="fa-brands fa-dribbble" /></a> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row align-items-center justify-content-between g-4">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-xl-12 col-lg-12 col-md-12">
                            <div className="form-group">
                              ...
                              <textarea className="form-control ht-120" defaultValue={""} />
                            </div>
                          </div>
                          <div className="col-xl-12 col-lg-12 col-md-12">
                            <div className="form-group mb-0">
                              <button type="button" className="btn fw-medium btn-primary">Send Message<i className="fa-solid fa-paper-plane ms-2" /></button>
                            </div>
                          </div>
                        </div>
                      </form>
                  ...
                  <div className="col-xl-5 col-lg-5 col-md-12">
                    <iframe className="full-width ht-100 grayscale rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095343008!2d-74.00425878428698!3d40.74076684379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sin!4v1586000412513!5m2!1sen!2sin" height={500} style={{border: 0}} aria-hidden="false" tabIndex={0} />
                  </div>
                </div>
              </div>
            </section>
